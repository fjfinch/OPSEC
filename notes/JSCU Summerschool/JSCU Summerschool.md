...
----------------
## Password dump
Een bestand met hashes. Het lijkt op NTLM hashes. (In hindsight gebruikte ik eerst de *rockyou.txt* lijst, die erop duidde dat elke hash 1 charakter is. Dus maakte ik een password bestand aan met alle charakters van ascii):
...
Alle emojis van het bestand gaven hiermee het volgende in hex:
